...
namespace Stroki
{
    public class Simvol
    {
        public void TipoMain()
        {
            ...
            void n14()
            {
                string Abloko = "вертикаль";
                Console.WriteLine("Из вертикаль в тир: " + Abloko[3] + Abloko[4] + Abloko[2]);
                Console.WriteLine("Из вертикаль в ветка: " + Abloko[0] + Abloko[1] + Abloko[3] + Abloko[5] + Abloko[6]);
            }
        }
    }
}